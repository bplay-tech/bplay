...
const DIAL_BY_COUNTRY: Record<string, string> = Object.fromEntries(
  COUNTRIES.map((country) => [country.name, country.dial])
);

export const dialCodeForCountry = (name: string): string => DIAL_BY_COUNTRY[name] ?? "";

export const DIAL_CODES: readonly string[] = Array.from(
